      ...
      <div className="container mx-auto">
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-4">
            <Link to="/" className="bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded-full transition-colors duration-300">Start exploring now</Link>
            <Link to="/register" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full transition-colors duration-300">Join the Community</Link>
          </div>
        </div>
      </div>
    </div>
